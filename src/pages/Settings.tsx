...
import { Plus, Trash2, ArrowLeft, Settings2, Package, Edit2, FileSpreadsheet, Receipt } from "lucide-react";
          ...
          <Card className="shadow-lg">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center justify-center gap-4">
                <Button
                  onClick={() => navigate("/settings/bill-records")}
                  className="w-full max-w-md bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white hover:scale-105 transition-all shadow-md h-14 text-lg rounded-xl"
                >
                  <Receipt className="h-5 w-5 mr-2" />
                  📋 View SPS Bill Records
                </Button>
                <Button
                  onClick={handleExportExcel}
                  disabled={billRecords.length === 0}
                  variant="outline"
                  className="w-full max-w-md hover:scale-105 transition-all h-12 text-base rounded-xl border-2 disabled:opacity-50"
                >
